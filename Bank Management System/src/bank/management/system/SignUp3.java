...
public class SignUp3 extends JFrame implements ActionListener{
    ...
    SignUp3(String formno) {
        ...
        JCheckBox c7 = new JCheckBox("I hearby by declears that the above entered details correct to the best of my acknowledge ",true);
        ...
        getContentPane().setBackground(new Color(215, 252, 222));
        setLayout(null);
        setSize(850, 800);
        setLocation(400, 20);
        setVisible(true);
